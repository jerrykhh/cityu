...
public class PersonnelOffice
{
	...
	public void report()
	{
		...
		for (Employee employee: allEmployees){ //Iterate through the array list based on allEmployees.size() 
			System.out.println(employee.toStringSalaryDetails()); //Call the toStringSalaryDetails methods of employees/managers: allEmployees.get(i).toStringSalaryDetails()
